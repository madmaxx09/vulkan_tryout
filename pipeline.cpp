...
namespace wind
{
	...
	PipelineConfigInfo Pipeline::defaultPipelineConfigInfo(uint32_t width, uint32_t height)
	{
		...
		configInfo.viewport.x = 0.0f; //le viewport mais ça on connait
		...
		configInfo.scissor.offset = {0,0}; //seul les choses comprises dans le ciseaux seront affichées
		configInfo.scissor.extent = {width, height}; //donc si je mutliplie une de ces valeurs par 0.5 seulemnt une moitié sera affichée
